...
export default function Home(props) {
  ...
  const handleEnviarRecado = async (e) => {
    ...
    if (recado.from.trim() !== "" && recado.message.trim() !== "") {
    ...
    <>
      ...
      <MainGrid>
          ...
          <Box>
            <div>
              ...
              <form onSubmit={handleEnviarRecado}>
                ...
                ></textarea>
                <button aria-label="enviar recado" disabled={sendingRecado}>
                  Enviar recado
                </button>
              </form>
              <br />
        ...
        <div style={{ gridArea: "profileRelationsArea" }}>
          <ProfileRelationsBox
            title="Seguindo"
            relationList={following}
            showRecentFirst={true}
            maxItensToShow={6}
          />
          <ProfileRelationsBox
            title="Seguidores"
            relationList={followers}
            showRecentFirst={true}
            maxItensToShow={6}
          />
          <ProfileRelationsBox
            title="Comunidades"
            relationList={comunidades}
            showRecentFirst={true}
            maxItensToShow={6}
          />
